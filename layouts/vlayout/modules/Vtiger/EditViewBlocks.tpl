                        ...
                        {foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
                            ...
                            <td class="fieldLabel {$WIDTHTYPE}">
                                {if $isReferenceField neq "reference"}
                                    <label id="label_{$FIELD_NAME}" class="muted pull-right marginRight10px">
                                    {/if}
                            ...
                            {if $FIELD_MODEL->get('uitype') neq "83"}
                                <td id="{$FIELD_NAME}" class="fieldValue {$WIDTHTYPE}" {if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '20'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
                                    <div class="row-fluid">
                                        <span class="span10">
